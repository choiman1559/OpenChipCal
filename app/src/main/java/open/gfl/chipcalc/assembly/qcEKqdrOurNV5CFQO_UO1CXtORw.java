...
public final /* synthetic */ class qcEKqdrOurNV5CFQO_UO1CXtORw implements Runnable {
    ...
    public /* synthetic */ qcEKqdrOurNV5CFQO_UO1CXtORw(Assembler assembler, BoardTemplate boardTemplate) {
        this.f$0 = assembler;
        this.f$1 = boardTemplate;
    }

    public final void run() {
        this.f$0.lambda$start$0$Assembler(this.f$1);
    }
}